...
from users.views import AssignRoleView, CustomLoginView, CustomPasswordResetView, EditProfileView, AdminDashboardView, create_group, GroupListView, sign_in, sign_out, sign_up, activate_user, ProfileView, ChangePassword, CustomPasswordResetConfirmView
