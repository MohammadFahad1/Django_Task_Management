...
from tasks.views import CreateTask, TaskDetail, UpdateTask, dashboard, manager_dashboard, UserDashboard, view_task, update_task, delete_task, Greetings, HiGreetings, HelloGreetings, ViewProject, UpdateTask
